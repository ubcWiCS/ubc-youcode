...
const Register = () => {
  return (
    <div className='flex flex-col items-center justify-center w-1/2'>
      <p className='text-xl text-white'>WiDS@UBC x UBC WiCS</p>
        <div className="max-w-sm">
          <Image src="/assets/youCode.png" height={130} width={550}  />
        </div>

      <p className='text-xl text-white'>24-hour wellness-themed hackathon</p>
      <p className='text-xl text-white'>April 5-6, 2024</p>
