  ...
  return (
    <div className=" mt-4 flex flex-col lg:mt-32  " id="sponsors">
      ...
      <div className="flex flex-col items-center justify-center mt-4 md:mt-10 lg:mt-24 rounded-2xl bg-white/[0.1] p-3 md:p-10 lg:p-20 mx-8 md:mx-20">
        <div className="flex w-28 h-16 md:w-48 md:h-36 lg:w-6/12 lg:h-80 items-center justify-center relative">
          <Image src="/assets/arcteryx.png" layout="fill" objectFit="contain" alt="Arcteryx" />
        </div>
        <div className="flex w-28 h-20 md:w-48 md:h-36 lg:w-5/12 lg:h-72 items-center justify-center relative">        
        ...
        <div className="flex w-full gap-4 md:gap-10 lg:gap-20 items-center justify-center">
          <div className="flex w-2/12 h-8 md:h-12 lg:w-4/12 lg:h-24 relative">
        ...
        <div className="flex w-full mt-3 md:mt-8 lg:mt-16 gap-4 md:gap-10 lg:gap-20 items-center justify-center">
          <div className="flex w-2/12 h-8 md:h-12 lg:w-4/12 lg:h-16 items-center justify-center relative">
            <Image src="/assets/plainview.png" layout="fill" objectFit="contain" alt="Plainview" />
          </div>
        </div>      
        <div className="flex w-full mt-4 md:mt-10 lg:mt-20 items-center justify-center">
