      ...
      <div className="flex flex-col p-2 md:p-10">
        <div className="flex"> 
          <div className="mx-2 md:mx-10 w-60 h-10 w-80 md:h-40 relative" ref={cloud1Ref} style={cloud1Style}>
            ...
            <p className='text-[10px] md:text-3xl font-bold text-dark-green absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 font-bold '>100+ Participants</p>
          </div>
          <div className="mx-2 md:mx-10 w-60 h-10 w-80 md:h-40 relative" ref={cloud2Ref} style={cloud2Style}>
          <Image src="/assets/cloud.png" fill />
            <p className='text-[10px] md:text-3xl font-bold text-dark-green absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10'>30+ Projects</p>
          </div>
        </div>
