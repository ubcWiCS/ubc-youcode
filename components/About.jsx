  ...
  return (
    <div className='flex'>
      <div className="flex flex-col w-1/2">
        <div className="text-5xl text-dark-green font-bold drop-shadow-[0_0_4px_#E2D6FF] ">
          About youCode:
        </div>
        <Stats/>
      </div>
      <div className='w-1/2'>
        <p className='text-white text-lg mr-20 mt-10'>
        ...
        <p className='text-white text-lg mr-20 mt-10 font-bold'>
