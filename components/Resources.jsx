...
const Resources = () => {
  const Resource = (props) => {
    return (
      <div className="relative flex flex-row">
        ...
        <a className="text-[9px]  md:text-sm lg:text-lg w-2/12  px-2 md:px-6 py-[1px] md:py-2 text-center bg-red-500 rounded-3xl " href={ props.link }>Link</a>
        </div>
  ...
  return (
    <div className='resources ml-10 mt-4 md:mt-20 ' id="resources">
    ...
    <div className="relative flex flex-row">
      ...
      <div className='text-[9px] font-semibold  md:text-lg text-black w-4/12 md:w-3/12'>Title</div>
      <div className='text-[9px] font-semibold  md:text-lg text-black w-4/12'>Topic</div>
      <div className='text-[9px] font-semibold  md:text-lg text-black ml-2 w-2/12'>Link</div>
    </div>
    <hr className=" md:my-3 border-black w-10/12 md:w-9/12" />
