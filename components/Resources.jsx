...
const Resources = () => {
  const Resource = (props) => {
    return (
      <div className="relative flex flex-row">
        <div className=" text-[9px] md:text-sm lg:text-lg w-1/12">{ props.number }</div>
        <div className="text-[9px]  md:text-sm lg:text-lg w-4/12 ">{ props.title }</div>
        <div className="text-[9px]  md:text-sm lg:text-lg w-5/12">{ props.topic }</div>
        <div className="text-[9px]  md:text-sm lg:text-lg w-2/12 ">
  ...
  return (
    <div className='resources ml-8 mt-4 md:mt-0' id="resources">
      <div className="text-lg  md:text-3xl lg:text-5xl text-dark-green font-bold mb-1 lg:mb-7 drop-shadow-[0_0_4px_#E2D6FF] ">
