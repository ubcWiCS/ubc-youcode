    ...
    <div>
      <div className="flex flex-col p-10 md:ml-40">
        <div className="flex w-2/3"> 
          <div className="mx-10 w-60 md:mx-10  h-10 w-80 md:h-40 relative" ref={cloud1Ref} style={cloud1Style}>
          ...
          <div className="mr-2 md:mr-16  w-60 md:mx-10  h-10 w-80 md:h-40 relative" ref={cloud2Ref} style={cloud2Style}>
              <Image src="/assets/cloud.png" fill />
            <p className='textt-xs md:text-3xl font-bold text-dark-green absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10'>25+ Volunteers & Mentors </p>
          </div>
        </div>
